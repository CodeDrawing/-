...
<head lang="en">
    ...
    <link href="../../../../../../../qq文件/Tedu/WebRoot/css/header.css" rel="stylesheet"/>
    <link href="../../../../../../../qq文件/Tedu/WebRoot/css/footer.css" rel="stylesheet"/>
    <link href="../../../../../../../qq文件/Tedu/WebRoot/css/animate.css" rel="stylesheet"/>
    <link href="../../../../../../../qq文件/Tedu/WebRoot/css/login.css" rel="stylesheet"/>
</head>
<body>
<!-- 页面顶部-->
<header id="top">
    <div class="top">
        <img src="../../../../../../../qq文件/Tedu/WebRoot/images/header/logo.png" alt=""/>
        <span>欢迎注册</span>
    </div>
</header>
<div class="parent">
        ...
        <div class="panel rt">
            <form id="form-register" method="post" action="">
                <div class="txt">
                    <p>新用户注册
                        <span>
              <a href="../../../../../../../qq文件/Tedu/WebRoot/web/login.html">直接登录</a>
            </span>
                    </p>
                </div>
...
<div id="foot_box">
    <div class="icon1 lf">
        <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/icon1.png" alt=""/>

        <h3>品质保障</h3>
    </div>
    <div class="icon2 lf">
        <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/icon2.png" alt=""/>

        <h3>私人定制</h3>
    </div>
    <div class="icon3 lf">
        <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/icon3.png" alt=""/>

        <h3>学员特供</h3>
    </div>
    <div class="icon4 lf">
        <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/icon4.png" alt=""/>
...
<div class="foot_bj">
    <div id="foot">
        <div class="lf">
            <p class="footer1"><img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/logo.png" alt=""
                                    class=" footLogo"/></p>
            <p class="footer2"><img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/footerFont.png" alt=""/>
            </p>
        ...
        <div class="foot_left lf">
            ...
            <ul>
                ...
                <li><a href="#">联系我们</a></li>
                <li>
                    <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/wechat.png" alt=""/>
                    <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/sinablog.png" alt=""/>
                </li>
            </ul>
        </div>
        <div class="service">
            <p>商城客户端</p>
            <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/ios.png" class="lf">
            <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/android.png" alt="" class="lf"/>
        </div>
        <div class="download">
            <img src="../../../../../../../qq文件/Tedu/WebRoot/images/footer/erweima.png">
        </div>
        <!-- 页面底部-备案号 #footer -->
        <div class="record">
...
<!--弹出的小广告-->
<script src="../../../../../../../qq文件/Tedu/WebRoot/js/jquery-3.1.1.min.js"></script>
<script>
